...
from models import db, User, Role, UserActivity, LoginAttempt
...
def users():
    ...
    per_page = 10  # số người dùng mỗi trang
...
def admin_reports():
    ...
    ).group_by(LoginAttempt.status).all()
...
def add_user():
    ...
    return render_template('add_edit_user.html', form=form, user=None)